...
<html lang="zh-CN">
	...
	<Form class="text-center" action="/FoundITClient/updateApp">
     	<h2>cover letter</h2>
      	<textarea class="form-control" rows="15" onkeyup="showUpdate()" style="width:1000px; margin-left: auto; margin-right: auto;" id="coverLetter" name = "coverLetter" required>${app.getCoverLetter()}</textarea>
        <br>
