  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="page-header">
        <h1>Recommend Available Jobs</h1>
      </div>
      <br/>
        <div class="col-md-12">
             ...
             <c:forEach items="${jobs.getJobs()}" var="job">
              <tr>
                ...
                <td>${job.getLocation()}</td>
  				<td><form action="/FoundITClient/canJobDetail">
  					<input type = "hidden" value = "${job.getKey()}" name="jobDetail">
  					<button class="btn btn-s btn-basic" type = "submit">details</button>
  				</form></td>
              </tr>
            </c:forEach>
            </tbody>
    ...
    <script src="/FoundITClient/resources/assets/js/docs.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="/FoundITClient/resources/assets/js/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>
